...
declare module '$env/static/private' {
	...
	export const EVOLUTION_API_URL: string;
	export const EVOLUTION_API_KEY: string;
	export const EVOLUTION_INSTANCE: string;
	export const WEBHOOK_SECRET: string;
	export const CORE_PORT: string;
	export const WA_ADAPTER_PORT: string;
	export const DATABASE_URL: string;
	export const DASHBOARD_PORT: string;
	export const DASHBOARD_ORIGIN: string;
	export const WA_ADAPTER_URL: string;
	export const CORE_BACKEND_URL: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		CORE_PORT: string;
		WA_ADAPTER_PORT: string;
		DATABASE_URL: string;
		DASHBOARD_PORT: string;
		DASHBOARD_ORIGIN: string;
		WA_ADAPTER_URL: string;
